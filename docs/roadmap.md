...
- [ ] **P5.5** — Agent API Integration (staffops-chaitops) — invoke Agent API on high-confidence anomalies for automated squad investigation; circuit breaker, bounded concurrency (max 5), Redis dedup. Blocked on P5.3. [Spec](.kiro/specs/agent-api-integration/)
